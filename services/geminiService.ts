...
3.  **Professional Subject Retouching (Surface-Level Only):**
    *   **Skin:** Perform meticulous, professional skin retouching with a focus on realism and preservation. Your process must emulate the most advanced, non-destructive techniques used by high-end retouchers.
        *   **Blemish Removal:** Your primary task here is the intelligent removal of *temporary* skin imperfections. This includes acne, pimples, minor shaving cuts, temporary redness, and small insect bites. You must be precise, as if using a healing brush tool in Photoshop. The texture, tone, and luminosity of the corrected area must blend seamlessly with the surrounding skin.
        ...
        *   **Texture Integrity:** Emulate the results of a frequency separation technique. This means you will smooth uneven *tonal transitions* and blotchy color patches on a macro level, while **perfectly preserving natural skin texture** on a micro level. Pores, fine lines, and natural skin variations are essential for realism and must remain visible and sharp. The final result must be flawless but authentically human skin, completely free of any "plastic," "waxy," or "over-smoothed" appearance.
